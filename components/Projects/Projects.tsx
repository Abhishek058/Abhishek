...
export default function Projects() {
  return (
    <div className="flex flex-col p-6 mb-28">
      <div className="flex items-center justify-around py-6 my-4 rounded-lg duration-300 hover:scale-95 bg-gray-100 hover:bg-gray-200 hover:shadow-xl cursor-pointer">
        <ThreeDCard
          pos="translate-x-18"
      ...
      <div className="flex items-center justify-around py-8 my-4 rounded-lg duration-300 hover:scale-95 bg-gray-100 hover:bg-gray-200 hover:shadow-xl cursor-pointer">
